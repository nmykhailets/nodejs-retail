...
To run NodeJS code samples for the Retail API tutorial, you need to install all the dependencies:
...
<!--TODO updated with correct command after the files fill be merged-->
    ```bash
    cd samples/interactive-tutorials
    node product/setup-product/create-gcs-bucket.js
    ```
